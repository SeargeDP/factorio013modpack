...
do	--[[automatization]]--
  if z_balance.bob_inserters and bobmods and bobmods.inserters then
...
do	--[[parts]]--
	...
	aadd("z-parts-01",			"y-dirt",						"a")
	aadd("z-parts-01",			"y-digfdirt-recipe",			"a")
	aadd("z-parts-01",			"y-digfdirt2-recipe",			"b")
	aadd("z-parts-01",			"y-coal-dust",					"c")
	aadd("z-parts-01",			"y-crush-yres1",				"d")
	aadd("z-parts-01",			"y-crush-unicomp-raw-recipe",	"d")
	aadd("z-parts-01",			"y-crush-yres2",				"e")
	aadd("z-parts-01",			"y-crush-fuel-raw-recipe",		"e")
	aadd("z-parts-01",			"y-filtering-dust-recipe",		"f")
	aadd("z-parts-01",			"y-crush-blue_whead-recipe",	"g")
	aadd("z-parts-01",			"y-crush-green_whead-recipe",	"h")
	aadd("z-parts-01",			"y-richdust",					"i")
	aadd("z-parts-01",			"y-mixing-rich-recipe",			"i")

	aadd("z-parts-02",			"y-c_mud",						"a")
	aadd("z-parts-02",			"y-release-cwater",				"a")
	aadd("z-parts-02",			"y-wash-special-recipe",		"b")
	aadd("z-parts-02",			"y-toxic-dust",					"c")
	aadd("z-parts-02",			"y-dry_mud",					"d")
	aadd("z-parts-02",			"y-pressed_dry_mud-recipe",		"d")
	aadd("z-parts-02",			"y_slag_granulate",				"e")
	aadd("z-parts-02",			"y-slag",						"f")
	aadd("z-parts-02",			"y-unicomp-raw",				"g")
	aadd("z-parts-02",			"y-unicomp-a2",					"h")
	aadd("z-parts-02",			"y-press-richdust-recipe",		"h")
	aadd("z-parts-02",			"y-orange-stuff",				"i")
	aadd("z-parts-02",			"y-smelt-richdust-recipe",		"i")
	aadd("z-parts-02",			"y-crystal2",					"j")
	aadd("z-parts-02",			"y-raw-fuelnium",				"k")
	
	aadd("z-parts-03",			"y-pure-iron",					"a")
	aadd("z-parts-03",			"y_pure_iron_wtool_recipe",		"b")
	aadd("z-parts-03",			"y-pure-copper",				"c")
	aadd("z-parts-03",			"y_pure_copper_wtool_recipe",	"d")
	aadd("z-parts-03",			"y-refined-yres1",				"e")
	aadd("z-parts-03",			"y-smelt-crush-res1-recipe",	"e")
	aadd("z-parts-03",			"y-refined-yres2",				"f")
	aadd("z-parts-03",			"y-smelt-crush-res2-recipe",	"f")
	aadd("z-parts-03",			"y_slag_brick",					"g")
	aadd("z-parts-03",			"y_slag_brick_recipe",			"g")
	aadd("z-parts-03",			"y_slag_brick_burn_recipe",		"h")
	aadd("z-parts-03",			"y-wash-dirt-recipe",			"i")
	
	aadd("z-parts-04",			"y_drillhead",					"a")
	aadd("z-parts-04",			"y_drillhead_broken",			"b")
	aadd("z-parts-04",			"y_drillhead_repair_recipe",	"c")
	aadd("z-parts-04",			"y_toolhead",					"d")
	aadd("z-parts-04",			"y_toolhead_broken",			"e")
	aadd("z-parts-04",			"y_toolhead_repair_recipe",		"f")
	aadd("z-parts-04",			"y_block_cold",					"g")
	aadd("z-parts-04",			"y_block_heat",					"h")
	
	aadd("z-parts-05",			"y-heat-pipe",					"a")
	aadd("z-parts-05",			"y-bluegear",					"b")
	aadd("z-parts-05",			"y_structure_element",			"c")
	aadd("z-parts-05",			"y_structure_vessel",			"d")
	aadd("z-parts-05",			"y_blocked_capa",				"f")
	aadd("z-parts-05",			"y-basic-t1-mf",				"g")
	aadd("z-parts-05",			"y-basic-st1-mf-recipe",		"g")
	aadd("z-parts-05",			"y-basic-t2-mf",				"h")
	aadd("z-parts-05",			"y-basic-st2-mf-recipe",		"h")
	
	aadd("z-parts-06",			"y-conductive-wire-1",			"a")
	aadd("z-parts-06",			"y-conductive-coil-1",			"b")
	aadd("z-parts-06",			"yi_magnetron",					"c")
	aadd("z-parts-06",			"y_dotzetron",					"d")
	aadd("z-parts-06",			"y_chip_plate",					"e")
	aadd("z-parts-06",			"y-chip-1",						"f")
	aadd("z-parts-06",			"y-chip1-recipe",				"f")
	aadd("z-parts-06",			"y-chip-2",						"g")
	aadd("z-parts-06",			"y-chip2-recipe",				"g")
	
	aadd("z-parts-07",			"y_organic_dust",				"a")
	aadd("z-parts-07",			"y_granulate_wood_recipe",		"a")
	aadd("z-parts-05",			"y_gauge",						"b")
	aadd("z-parts-05",			"y_gauge_analog_recipe",		"b")
	aadd("z-parts-07",			"y_catalyst_base",				"c")
	aadd("z-parts-07",			"y_usedcatalyst",				"d")
	aadd("z-parts-07",			"y_catalyst_bp",				"e")
	aadd("z-parts-07",			"y_catalyst_ft",				"f")
	aadd("z-parts-07",			"y_regcatbp_recipe",			"g")
	aadd("z-parts-07",			"y_regcatft_recipe",			"h")
	
	aadd("z-parts-08",			"y-fuel-reactor",				"b")
	aadd("z-parts-08",			"y-infused-uca2",				"c")
	aadd("z-parts-08",			"y_crystal2_combined",			"d")
	aadd("z-parts-08",			"y_data_crystal_recipe",		"d")
	aadd("z-parts-08",			"y-crystal-cnd",				"e")
	aadd("z-parts-08",			"y-quantrinum",					"f")
	aadd("z-parts-08",			"y_quantrinum_infused",			"g")
	aadd("z-parts-08",			"y_quantrinum_infusion_recipe",	"g")
