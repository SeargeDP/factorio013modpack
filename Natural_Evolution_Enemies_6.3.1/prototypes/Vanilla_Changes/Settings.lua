...
Resistances = {
	...
	Small_Biter = {
      ...
      {type = "physical", decrease = 1, percent = 5*NE_Difficulty},
	...
	Small_Biter_Mk2 = {
      ...
      {type = "poison", decrease = 2, percent = 5*NE_Difficulty},
      {type = "laser", decrease = 1, percent = 0}},
	  
	-- Mutated (Acid / Laser)  
	Small_Biter_Mk3 = {
	  {type = "fire", decrease = 0, percent = -80},
      {type = "physical", decrease = 4, percent = 5*NE_Difficulty},
      ...
      {type = "laser", decrease = 4, percent = 5*NE_Difficulty}},
	
	-- Healthy (Physical)
	Medium_Biter = {
	  {type = "fire", decrease = 0, percent = -75},
      {type = "physical", decrease = 6, percent = 10*NE_Difficulty},
	...
	Medium_Biter_Mk2 = {
      ...
      {type = "explosion", decrease = 8, percent = 10*NE_Difficulty},
      {type = "acid", decrease = 6, percent = 0},
      {type = "poison", decrease = 8, percent = 10*NE_Difficulty},
	...
	Big_Biter = {
      ...
      {type = "physical", decrease = 14, percent = 15*NE_Difficulty},
	...
	Big_Biter_Mk2 = {
      ...
      {type = "explosion", decrease = 16, percent = 15*NE_Difficulty},
      {type = "acid", decrease = 12, percent = 0},
      {type = "poison", decrease = 16, percent = 15*NE_Difficulty},
	...
	Big_Biter_Mk3 = {
      ...
      {type = "acid", decrease = 18, percent = 15*NE_Difficulty},
      {type = "poison", decrease = 14, percent = 0},
      {type = "laser", decrease = 18, percent = 15*NE_Difficulty}},
	
	-- Healthy (Physical)	
	Behemoth_Biter = {
	  {type = "fire", decrease = 0, percent = -40},
      {type = "physical", decrease = 20, percent = 20*NE_Difficulty},
	...
	Small_Spitter_Mk3 = {
      ...
      {type = "impact", decrease = 2, percent = 0},
      {type = "explosion", decrease = 2, percent = 0},
      {type = "acid", decrease = 3, percent = 5*NE_Difficulty},
      {type = "poison", decrease = 2, percent = 0},
	...
	Medium_Spitter = {
	  {type = "fire", decrease = 0, percent = -75},
      {type = "physical", decrease = 4, percent = 10*NE_Difficulty},
	...
	Medium_Spitter_Mk2 = {
      ...
      {type = "acid", decrease = 4, percent = 0},
      {type = "poison", decrease = 5, percent = 10*NE_Difficulty},
      {type = "laser", decrease = 4, percent = 0}},
	...
	Medium_Spitter_Mk3 = {
      ...
      {type = "acid", decrease = 6, percent = 10*NE_Difficulty},
      {type = "poison", decrease = 5, percent = 0},
      {type = "laser", decrease = 6, percent = 10*NE_Difficulty}},
	...
	Big_Spitter_Mk2 = {
      ...
      {type = "explosion", decrease = 9, percent = 15*NE_Difficulty},
      {type = "acid", decrease = 7, percent = 0},
      {type = "poison", decrease = 9, percent = 15*NE_Difficulty},
	...
	Big_Spitter_Mk3 = {
      ...
      {type = "impact", decrease = 8, percent = 0},
      {type = "explosion", decrease = 8, percent = 0},
      {type = "acid", decrease = 10, percent = 15*NE_Difficulty},
      {type = "poison", decrease = 8, percent = 0},
	...
	Behemoth_Spitter = {
	  {type = "fire", decrease = 0, percent = -40},
      {type = "physical", decrease = 14, percent = 20*NE_Difficulty},
      {type = "impact", decrease = 10, percent = 0},
      {type = "explosion", decrease = 10, percent = 0},
      {type = "acid", decrease = 10, percent = 0},
      {type = "poison", decrease = 10, percent = 0},
