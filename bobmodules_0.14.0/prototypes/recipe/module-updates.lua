...
if data.raw.item["ruby-5"] then
  bobmods.lib.recipe.replace_ingredient("speed-module-5", "alien-artifact", "ruby-5")
  bobmods.lib.recipe.replace_ingredient("effectivity-module-5", "alien-artifact", "ruby-5")
  bobmods.lib.recipe.replace_ingredient("productivity-module-5", "alien-artifact", "ruby-5")
  bobmods.lib.recipe.replace_ingredient("pollution-clean-module-5", "alien-artifact", "ruby-5")
  bobmods.lib.recipe.replace_ingredient("pollution-create-module-5", "alien-artifact", "ruby-5")
end

if data.raw.item["emerald-5"] then
  bobmods.lib.recipe.replace_ingredient("speed-module-6", "alien-artifact", "emerald-5")
  bobmods.lib.recipe.replace_ingredient("effectivity-module-6", "alien-artifact", "emerald-5")
  bobmods.lib.recipe.replace_ingredient("productivity-module-6", "alien-artifact", "emerald-5")
  bobmods.lib.recipe.replace_ingredient("pollution-clean-module-6", "alien-artifact", "emerald-5")
  bobmods.lib.recipe.replace_ingredient("pollution-create-module-6", "alien-artifact", "emerald-5")
end

if data.raw.item["topaz-5"] then
  bobmods.lib.recipe.replace_ingredient("speed-module-7", "alien-artifact", "topaz-5")
  bobmods.lib.recipe.replace_ingredient("effectivity-module-7", "alien-artifact", "topaz-5")
  bobmods.lib.recipe.replace_ingredient("productivity-module-7", "alien-artifact", "topaz-5")
  bobmods.lib.recipe.replace_ingredient("pollution-clean-module-7", "alien-artifact", "topaz-5")
  bobmods.lib.recipe.replace_ingredient("pollution-create-module-7", "alien-artifact", "topaz-5")
end

if data.raw.item["diamond-5"] then
  bobmods.lib.recipe.replace_ingredient("speed-module-8", "alien-artifact", "diamond-5")
  bobmods.lib.recipe.replace_ingredient("effectivity-module-8", "alien-artifact", "diamond-5")
  bobmods.lib.recipe.replace_ingredient("productivity-module-8", "alien-artifact", "diamond-5")
  bobmods.lib.recipe.replace_ingredient("pollution-clean-module-8", "alien-artifact", "diamond-5")
  bobmods.lib.recipe.replace_ingredient("pollution-create-module-8", "alien-artifact", "diamond-5")
end
