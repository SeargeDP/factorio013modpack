...
if data.raw.item["titanium-bearing"] then
  ...
  bobmods.lib.recipe.add_new_ingredient("bob-armoured-diesel-locomotive-2", {"titanium-bearing", 16})
  bobmods.lib.recipe.add_new_ingredient("bob-armoured-cargo-wagon-2", {"titanium-bearing", 8})
else
  ...
  bobmods.lib.recipe.add_new_ingredient("bob-armoured-diesel-locomotive-2", {"iron-gear-wheel", 10})
  bobmods.lib.recipe.add_new_ingredient("bob-armoured-cargo-wagon-2", {"iron-gear-wheel", 8})
end
...
if data.raw.item["titanium-gear-wheel"] then
  ...
  bobmods.lib.recipe.replace_ingredient("bob-armoured-diesel-locomotive-2", "iron-gear-wheel", "titanium-gear-wheel")
...
if data.raw.item["tungsten-carbide"] then
  ...
  if data.raw.item["silicon-nitride"] then
    bobmods.lib.recipe.remove_ingredient("bob-armoured-diesel-locomotive-2", "steel-plate")
    bobmods.lib.recipe.add_ingredient("bob-armoured-diesel-locomotive-2", {"tungsten-carbide", 15})
    bobmods.lib.recipe.add_ingredient("bob-armoured-diesel-locomotive-2", {"silicon-nitride", 15})
    ...
    bobmods.lib.recipe.replace_ingredient("bob-armoured-diesel-locomotive-2", "steel-plate", "tungsten-carbide")
    bobmods.lib.recipe.replace_ingredient("bob-armoured-cargo-wagon-2", "steel-plate", "tungsten-carbide")
  end
else
  if data.raw.item["silicon-nitride"] then
    bobmods.lib.recipe.replace_ingredient("bob-armoured-diesel-locomotive-2", "steel-plate", "silicon-nitride")
