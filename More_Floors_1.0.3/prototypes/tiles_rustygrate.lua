data:extend(
{
  {	
      ...
      minable = {hardness = 0.2, mining_time = 0.5, result = "rusty-grate"},
      ...
      variants =
      {
        ...
        {
          {
            picture = "__More_Floors__/graphics/terrain/metal-floor/rusty-grate1.png",
            count = 16,
            size = 1
          },
          {
            picture = "__More_Floors__/graphics/terrain/metal-floor/rusty-grate2.png",
            count = 4,
            size = 2,
            probability = 0.39,
          },
          {
            picture = "__More_Floors__/graphics/terrain/metal-floor/rusty-grate4.png",
            count = 4,
            size = 4,
            probability = 1,
          },
