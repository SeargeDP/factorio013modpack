...
--TIER 1
    ...
    effects =
    {
	  ...
	  {
        type = "unlock-recipe",
        recipe = "slag-processing-bob-1"
      },
	  {
        type = "unlock-recipe",
        recipe = "slag-processing-bob-2"
      },
	  {
        type = "unlock-recipe",
        recipe = "slag-processing-bob-3"
      },
	  {
        type = "unlock-recipe",
...
--TIER 2
    ...
    effects =
    {
	  ...
	  {
        type = "unlock-recipe",
        recipe = "slag-processing-bob-4"
      },
	  {
        type = "unlock-recipe",
        recipe = "slag-processing-bob-5"
      },
  	  {
        type = "unlock-recipe",
        recipe = "slag-processing-bob-6"
      },
	  {
        type = "unlock-recipe",
