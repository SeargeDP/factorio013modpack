if data.raw.tool["science-pack-4"] then
  bobmods.lib.tech.replace_science_pack("bob-drills-4", "alien-science-pack", "science-pack-4")
end
...
if data.raw.item["invar-alloy"] then
  ...
  if data.raw.item["aluminium-plate"] then
    bobmods.lib.recipe.replace_ingredient("bob-mining-drill-2", "steel-plate", "aluminium-plate")
    bobmods.lib.tech.add_prerequisite("bob-drills-2", "aluminium-processing")
  else
