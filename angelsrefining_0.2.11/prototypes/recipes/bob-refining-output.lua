...
--STONE & SLAG
	...
	enabled = "false",
    ingredients ={
    {type="fluid", name="slag-slurry", amount=2.5},
    {type="fluid", name="water", amount=5},
    {type="item", name="filter-ceramic", amount=1},
	},
    results=
	...
	enabled = "false",
    ingredients ={
    {type="fluid", name="thermal-water", amount=2.5},
    {type="item", name="filter-ceramic", amount=1},
	},
    results=
    {
    ...
    order = "a-a [slag-processing-bob-1]",
	},
	{
    type = "recipe",
    name = "slag-processing-bob-2",
    category = "crystallizing",
	subgroup = "slag-processing",
    energy_required = 8,
	enabled = "false",
    ...
    order = "a-a [slag-processing-bob-2]",
	},
	{
    type = "recipe",
    name = "slag-processing-bob-3",
    category = "crystallizing",
	subgroup = "slag-processing",
    energy_required = 8,
	enabled = "false",
    ...
    order = "a-a [slag-processing-bob-3]",
	},
	{
    type = "recipe",
    name = "slag-processing-bob-4",
    category = "crystallizing",
	subgroup = "slag-processing",
    energy_required = 8,
	enabled = "false",
    ...
    order = "a-a [slag-processing-bob-4]",
	},
	{
    type = "recipe",
    name = "slag-processing-bob-5",
    category = "crystallizing",
	subgroup = "slag-processing",
    energy_required = 8,
	enabled = "false",
    ...
    order = "a-a [slag-processing-bob-5]",
	},
	{
    type = "recipe",
    name = "slag-processing-bob-6",
    category = "crystallizing",
	subgroup = "slag-processing",
    energy_required = 8,
	enabled = "false",
    ...
    order = "a-a [slag-processing-bob-6]",
	},
	{
    type = "recipe",
...
--TIER 4
    ...
    ingredients ={
	  ...
	  -- {type="item", name="geode-cyan", amount=1},	
	  -- {type="item", name="geode-lightgreen", amount=1},	
	},
    results=
    {
...
--ADVANCED GEMs
    ...
    icon = "__angelsrefining__/graphics/icons/angelsore7-chunk-mix-processing.png",
    ...
    icon = "__angelsrefining__/graphics/icons/angelsore7-crystal-mix-processing.png",
    ...
    icon = "__angelsrefining__/graphics/icons/angelsore7-pure-mix-processing.png",
