...
--STONE & SLAG
    ...
    results=
    {
	  ...
	  {type="item", name="silica-ore", amount=1, probability=0.4},
    },
...
--Tier 1
    ...
    results=
    {
      ...
      {type="item", name="silica-ore", amount=1},
	  {type="item", name="slag", amount=1},
    },
...
--TIER 2 MIX
    ...
    results=
    {
	  {type="item", name="silica-ore", amount=4},
    },
...
--TIER 4
    ...
    {
	  {type="item", name="tin-ore", amount=3},
      {type="item", name="silica-ore", amount=2},
	  {type="item", name="bauxite-ore", amount=1},
	  {type="item", name="manganese-ore", amount=1},
	  {type="item", name="rutile-ore", amount=1},
	  {type="item", name="chrome-ore", amount=1},
