...
if data.raw.item["advanced-processing-unit"] then
  ...
  bobmods.lib.recipe.replace_ingredient("tank-3", "processing-unit", "advanced-processing-unit")
  bobmods.lib.tech.add_prerequisite("tanks-3", "advanced-electronics-3")
end
...
if data.raw.item["titanium-plate"] then
  ...
  bobmods.lib.recipe.replace_ingredient("tank-2", "steel-plate", "titanium-plate")
  bobmods.lib.tech.add_prerequisite("tanks-2", "titanium-processing")
end
...
if data.raw.item["titanium-gear-wheel"] then
  ...
  bobmods.lib.recipe.replace_ingredient("tank-2", "iron-gear-wheel", "titanium-gear-wheel")
end
...
if data.raw.item["titanium-bearing"] then
  ...
  bobmods.lib.recipe.add_ingredient("tank-2", {"titanium-bearing", 15})
end
...
if data.raw.item["silicon-nitride"] then
  ...
  bobmods.lib.recipe.replace_ingredient("tank-3", "plastic-bar", "silicon-nitride")
  bobmods.lib.tech.add_prerequisite("tanks-3", "ceramics")
end
...
if data.raw.item["copper-tungsten-alloy"] then
  bobmods.lib.recipe.replace_ingredient("tank-3", "steel-plate", "tungsten-carbide")
  bobmods.lib.tech.add_prerequisite("tanks-3", "tungsten-alloy-processing")
end
...
if data.raw.item["nitinol-gear-wheel"] then
  ...
  bobmods.lib.tech.add_prerequisite("tanks-3", "nitinol-processing")
  bobmods.lib.recipe.replace_ingredient("tank-3", "iron-gear-wheel", "nitinol-gear-wheel")
end
...
if data.raw.item["nitinol-bearing"] then
  ...
  bobmods.lib.recipe.add_ingredient("tank-3", {"nitinol-bearing", 15})
end
