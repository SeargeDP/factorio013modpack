...
if angelsmods.refining.productivitytrigger then
angelsmods.refining.enableproductivity = true
else
angelsmods.refining.enableproductivity = false
end

if angelsmods.refining.furnacetrigger then
angelsmods.refining.enablefurnace = true
else
angelsmods.refining.enablefurnace = false
end
