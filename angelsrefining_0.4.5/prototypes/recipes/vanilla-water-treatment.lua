...
data.raw["recipe"]["angelsore1-chunk"].results[2]={type = "fluid", name = "water-yellow-waste", amount=5}
data.raw["recipe"]["angelsore2-chunk"].results[2]={type = "fluid", name = "water-yellow-waste", amount=5}
data.raw["recipe"]["angelsore3-chunk"].results[2]={type = "fluid", name = "water-yellow-waste", amount=5}
data.raw["recipe"]["angelsore4-chunk"].results[2]={type = "fluid", name = "water-yellow-waste", amount=5}
data.raw["recipe"]["angelsore5-chunk"].results[2]={type = "fluid", name = "water-yellow-waste", amount=5}
data.raw["recipe"]["angelsore6-chunk"].results[2]={type = "fluid", name = "water-yellow-waste", amount=5}
end
