...
bobmods.modules.AddProductivityLimitationKey = true
...
if bobmods and bobmods.config and bobmods.config.modules then
  ...
  if bobmods.config.modules.AddProductivityLimitationKey ~= nil then
    bobmods.modules.AddProductivityLimitationKey = bobmods.config.modules.AddProductivityLimitationKey
  end
...
if bobmods.modules.EnableProductivityLimitation == true then
  for i, module in pairs(data.raw.module) do
    if module.effect.productivity then
      if module.limitation_message_key then
        module.limitation = productivitymodulelimitation()
      else
        if bobmods.modules.AddProductivityLimitationKey == true then
          module.limitation = productivitymodulelimitation()
