...
if data.raw.item["ruby-5"] then
  bobmods.lib.recipe.replace_ingredient("green-module-5", "alien-artifact", "ruby-5")
end

if data.raw.item["emerald-5"] then
  bobmods.lib.recipe.replace_ingredient("green-module-6", "alien-artifact", "emerald-5")
end

if data.raw.item["topaz-5"] then
  bobmods.lib.recipe.replace_ingredient("green-module-7", "alien-artifact", "topaz-5")
end

if data.raw.item["diamond-5"] then
  bobmods.lib.recipe.replace_ingredient("green-module-8", "alien-artifact", "diamond-5")
end
