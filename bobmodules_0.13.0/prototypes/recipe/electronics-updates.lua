...
if data.raw.fluid["ferric-chloride-solution"] then
  bobmods.lib.recipe.add_ingredient("module-circuit-board", {"ferric-chloride-solution", 0.5})
  bobmods.lib.recipe.add_ingredient("module-processor-board", {"ferric-chloride-solution", 0.5})
  bobmods.lib.recipe.add_ingredient("module-processor-board-2", {"ferric-chloride-solution", 0.5})
  bobmods.lib.recipe.add_ingredient("module-processor-board-3", {"ferric-chloride-solution", 1})
end
