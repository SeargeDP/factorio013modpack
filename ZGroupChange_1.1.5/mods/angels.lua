...
do	--[[refining]]--
  if i_exist("angels-ore1") then
	...
	aadd("z-catalysts",			"catalysator-base",			"a")
	aadd("z-catalysts",			"catalysator-blue",			"b")
	aadd("z-catalysts",			"catalysator-green",		"c")
	aadd("z-catalysts",			"catalysator-orange",		"d")
	aadd("z-catalysts",			"catalysator-purple",		"e")
	aadd("z-catalysts",			"catalysator-red",			"f")
	aadd("z-catalysts",			"catalysator-yellow",		"g")
	aadd("z-catalysts",			"catalysator-brown",		"h")
	
	aadd("z-ore-processing-a",	"iron-ore-crushed",			"h[iron-crushed]")
	aadd("z-ore-processing-a",	"copper-ore-crushed",		"h[copper-crushed]")
	aadd("z-ore-processing-b",	"iron-ore-chunk",			"h[iron-chunk]")
	aadd("z-ore-processing-b",	"copper-ore-chunk",			"h[copper-chunk]")
	aadd("z-ore-processing-c",	"iron-ore-crystal",			"h[iron-crystal]")
	aadd("z-ore-processing-c",	"copper-ore-crystal",		"h[copper-crystal]")
	aadd("z-ore-processing-d",	"iron-ore-pure",			"h[iron-pure]")
	aadd("z-ore-processing-d",	"copper-ore-pure",			"h[copper-pure]")
	
	aadd("z-geode-processing",	"slag-processing-stone",	"z")
	aadd("z-geode-processing",	"slag",						"z")
	aadd("z-water-treatment",		"salt-water-electrolysis-2","a")
	aadd("z-water-treatment",		"water-mineralized",		"z")
	aadd("z-ore-crusher",			"burner-ore-crusher",		"e[burner-ore-crusher]")
	aadd("z-ore-crusher",			"burner-ore-crusher",		"e[burner-ore-crusher]")
