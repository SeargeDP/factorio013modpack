...
do	--[[gathering]]--
	aadd("z-gathering-0",		"5d-repair-pack-2",				"j",	"__ZGroupChange__/graphics/icons/repairpack-2.png")
...
do	--[[production]]--
	...
	aadd("z-production-4",		"5d-assembling-machine-4",	"d", "__ZGroupChange__/graphics/icons/assembling-machine-4.png")
	aadd("z-production-4",		"5d-assembling-machine-5",	"e", "__ZGroupChange__/graphics/icons/assembling-machine-5.png")
...
do	--[[logistic]]--
	aadd("z-logistic-1",		"5d-roboport-2",					"b", "__ZGroupChange__/graphics/icons/roboport2.png")
...
do	--[[trains-vehicles]]--
	aadd("z-vehicles-0",		"5d-truck",							"f")
	aadd("z-vehicles-0",		"5d-boat",							"g")
	aadd("z-vehicles-0",		"5d-air-plane",						"h")
end
do	--[[decorative]]--
	...
	aadd("z-decorative-2",			"5d-lamp",					"b")
	
	aadd("z-decorative-6",			"5d-banner-1",				"a")
	aadd("z-decorative-6",			"5d-banner-2",				"b")
	aadd("z-decorative-6",			"5d-banner-3",				"c")
	aadd("z-decorative-6",			"5d-obelisk",				"d")
	aadd("z-decorative-6",			"5d-statue",				"e")
